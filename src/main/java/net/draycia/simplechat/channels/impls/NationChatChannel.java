...
public class NationChatChannel extends ChatChannel {
    ...
    private NationChatChannel() { }

    private NationChatChannel(TextColor color, long id, Map<String, String> formats, String webhook, boolean isDefault, boolean ignorable, String name, double distance, String switchMessage, String toggleOffMessage, String toggleOnMessage, SimpleChat simpleChat) {
        this.color = color;
        this.id = id;
    ...
    public static NationChatChannel.Builder builder(String name) {
    ...
    public static class Builder extends ChatChannel.Builder {
        ...
        public NationChatChannel build(SimpleChat simpleChat) {
            return new NationChatChannel(color, id, formats, webhook, isDefault, ignorable, name, distance, switchMessage, toggleOffMessage, toggleOnMessage, simpleChat);
        }
