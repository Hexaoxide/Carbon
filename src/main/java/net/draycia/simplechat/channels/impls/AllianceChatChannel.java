...
public class AllianceChatChannel extends ChatChannel {
    ...
    private AllianceChatChannel() { }

    private AllianceChatChannel(TextColor color, long id, Map<String, String> formats, String webhook, boolean isDefault, boolean ignorable, String name, double distance, String switchMessage, String toggleOffMessage, String toggleOnMessage, SimpleChat simpleChat) {
        this.color = color;
        this.id = id;
    ...
    public static AllianceChatChannel.Builder builder(String name) {
    ...
    public static class Builder extends ChatChannel.Builder {
        ...
        public AllianceChatChannel build(SimpleChat simpleChat) {
            return new AllianceChatChannel(color, id, formats, webhook, isDefault, ignorable, name, distance, switchMessage, toggleOffMessage, toggleOnMessage, simpleChat);
        }
