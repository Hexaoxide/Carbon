...
public class TownChatChannel extends ChatChannel {
    ...
    private TownChatChannel() { }

    private TownChatChannel(TextColor color, long id, Map<String, String> formats, String webhook, boolean isDefault, boolean ignorable, String name, double distance, String switchMessage, String toggleOffMessage, String toggleOnMessage, SimpleChat simpleChat) {
        this.color = color;
        this.id = id;
    ...
    public static TownChatChannel.Builder builder(String name) {
