...
public class ChannelContextEvent implements CarbonEvent, Cancellable {

  private @NonNull final ChatChannel channel;
  private @NonNull final ChatUser user;
  private boolean cancelled = false;

  public ChannelContextEvent(final @NonNull ChatChannel channel, final @NonNull ChatUser user) {
