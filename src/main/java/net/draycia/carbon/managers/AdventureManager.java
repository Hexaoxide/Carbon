...
public class AdventureManager {
  ...
  @NonNull private final BukkitAudiences audiences;
  ...
  @NonNull
  public Component processMessageWithPapi(
      @NonNull Player player, @Nullable String input, @NonNull String @NonNull ... placeholders) {
  ...
  @NonNull
  public Component processMessage(
      @Nullable String input, @NonNull String @NonNull ... placeholders) {
    if (input == null || input.trim().isEmpty()) {
      return TextComponent.empty();
    }
  ...
  @NonNull
  private Component processMojang(
      @NonNull String input, @NonNull String @NonNull ... placeholders) {
