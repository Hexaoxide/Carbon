...
public class SudoChannelCommand {
  ...
  public SudoChannelCommand(
    ...
    new CommandAPICommand(commandSettings.getName())
        ...
        .executes(
            (sender, args) -> {
              this.sendMessageOther(
                  sender, (ChatUser) args[0], (ChatChannel) args[1], (String) args[2]);
            })
        .register();
  }

  private void setOtherChannel(
      @NonNull CommandSender sender, @NonNull ChatUser user, @NonNull ChatChannel channel) {
