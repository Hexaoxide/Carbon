...
public class AliasedChannelCommand {
  ...
  @NonNull private final ChatChannel chatChannel;
  ...
  private void setChannel(@NonNull Player player, @NonNull Object @NonNull [] args) {
      ...
      user.sendMessage(
          carbonChat
              ...
              .processMessageWithPapi(
                  player,
                  getChatChannel().getCannotUseMessage(),
                  "br",
                  "\n",
                  "color",
                  "<" + getChatChannel().getChannelColor(user).toString() + ">",
                  "channel",
                  getChatChannel().getName()));
    ...
    user.sendMessage(
        carbonChat
            ...
            .processMessageWithPapi(
                player,
                getChatChannel().getSwitchMessage(),
                "br",
                "\n",
                "color",
                "<" + getChatChannel().getChannelColor(user).toString() + ">",
