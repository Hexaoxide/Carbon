...
public final class WorldGuardContext implements Listener {
  ...
  @NonNull private static final String KEY = "worldguard-region";
  ...
  public void onChannelSwitch(ChannelSwitchEvent event) {
    ...
    if ((value instanceof String || value instanceof List)
        && !isInRegionOrRegions(value, event.getUser())) {
  ...
  public boolean testContext(
      @NonNull ChatUser sender, @NonNull ChatUser target, @Nullable Object value) {
